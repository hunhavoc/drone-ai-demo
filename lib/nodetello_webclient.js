...
var nodetello_webclient = function (videobackend) {
	...
	this._http_res = function (req, res) {
		...
		var type = url.split("."); 
			...
			type = (typeof this.file2mime[type] !== "undefined") ? this.file2mime[type] : {t: 'application/octet-stream', e: 'binary'};
			console.log(type);
